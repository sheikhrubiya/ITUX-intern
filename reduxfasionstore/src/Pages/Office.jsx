...
import image from '../assets/officesale.jpg'


const Office = ({addtocart, handleOpenModal, addtowishlist}) => {
  const data= Shop.filter((item)=>item.category==="Table")
  return (
    <div className='w-full flex flex-col gap-5 p-5'>
     <img className='h-[400px]' src={image}/>
      <h1 className='text-xl font-semibold text-center'>Office Collections</h1>
