...
const Living = () => {
  ...
  const living=Data.filter((item)=>item.category==='Sofa')
  return (
      ...
      <div className="w-60 h-full flex flex-col border-2 border-gray-200">
        ...
        <div className="flex flex-col p-2 text-gray-600 font-semibold">
          ...
          <div className="flex flex-row gap-2 hover:text-lg cursor-pointer">
            ...
            <p className="text-md font-light">3-Seater</p>
          </div>
          <div className="flex flex-row gap-2 hover:text-lg cursor-pointer">
            <span className="text-md font-light mt-1">
              <IoIosCheckboxOutline />
            </span>
            <p className="text-md font-light">5-Seater</p>
          </div>
          <div className="flex flex-row gap-2 hover:text-lg cursor-pointer">
            <span className="text-md font-light mt-1">
              <IoIosCheckboxOutline />
            </span>
            <p className="text-md font-light">L-Shape</p>
          </div>
        </div>
        <div className="flex flex-col p-2 text-gray-600 font-semibold">
        ...
        <div className="flex flex-col p-2 text-gray-600 font-semibold">
          <p className="text-xl font-normal py-2">Type</p>
          {/* <PriceRangeSlider min={200} max={1000} onChange={handleRangeChange}/> */}
          <div className="flex flex-row gap-2 hover:text-lg cursor-pointer">
            <span className="text-md font-light mt-1">
              <IoIosCheckboxOutline />
            </span>
            <p className="text-md font-light">Classic</p>
          </div>
          <div className="flex flex-row gap-2 hover:text-lg cursor-pointer">
            <span className="text-md font-light mt-1">
              <IoIosCheckboxOutline />
            </span>
            <p className="text-md font-light">Modern</p>
          </div>
        </div>
        <div className="flex flex-col p-2 text-gray-600 font-semibold">
